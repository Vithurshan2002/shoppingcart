...
const Sidebar = ({ brand, priceRange, selectbrands, setselectedbrands,setpricerange,selectRam,setRam,selectStorage,setStrorage}) => {
      ...
      {brand.map((brand, key) => (
        <label key={key} className="flex px-1 py-2 space-x-1 cursor-pointer">
          <input
            ...
            className="font-bold accent-emerald-800"
          />
